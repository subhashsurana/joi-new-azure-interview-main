...
resource "azurerm_linux_virtual_machine" "virtual-machine-quotes" {
  ...
  provisioner "file" {
    source      = var.provision_quotes_script_path
    destination = "/home/${var.admin_username}/provision-quotes.sh"
  }
  ...
  provisioner "remote-exec" {
    inline = [
      "chmod +x /home/${var.admin_username}/provision-quotes.sh",
      "/home/${var.admin_username}/provision-quotes.sh ${var.prefix}quotes${var.acr_url_default}/${var.prefix}quotes:latest ${data.azurerm_user_assigned_identity.identity-acr.id} ${var.prefix}quotes"
    ]
  }
}
...
resource "azurerm_linux_virtual_machine" "virtual-machine-newsfeed" {
  ...
  provisioner "file" {
    source      = var.provision_newsfeed_script_path
    destination = "/home/${var.admin_username}/provision-newsfeed.sh"
  }
  ...
  provisioner "remote-exec" {
    inline = [
      "chmod +x /home/${var.admin_username}/provision-newsfeed.sh",
      "/home/${var.admin_username}/provision-newsfeed.sh ${var.prefix}newsfeed${var.acr_url_default}/${var.prefix}newsfeed:latest ${data.azurerm_user_assigned_identity.identity-acr.id} ${var.prefix}newsfeed"
    ]
  }
}
...
resource "azurerm_linux_virtual_machine" "virtual-machine-frontend" {
  ...
  provisioner "file" {
    source      = var.provision_frontend_script_path
    destination = "/home/${var.admin_username}/provision-frontend.sh"
  }
  ...
  provisioner "remote-exec" {
    inline = [
      "chmod +x /home/${var.admin_username}/provision-frontend.sh",
  ...
  depends_on = [
    azurerm_linux_virtual_machine.virtual-machine-quotes,
